...
module.exports.Library = (Library = class Library {
  constructor(json, libraryManager) {
    ...
    this.expressions = {};
    for (var expr of (json.library.statements != null ? json.library.statements.def : undefined) != null ? (json.library.statements != null ? json.library.statements.def : undefined) : []) {
