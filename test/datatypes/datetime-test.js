...
describe('DateTime', function() {
  ...
  it('should not parse invalid strings', () => should.not.exist(DateTime.parse('20121025')));
...
describe('DateTime.add', function() {
  ...
  it('should not add anything on undefined fields', function() {
...
describe('DateTime.sameAs', function() {
  ...
  return it('should handle imprecision correctly with missing months', function() {
...
describe('DateTime.before', function() {
  ...
  it('should return null in cases where a is b but there are unknown values', function() {
    ...
    return should.not.exist(DateTime.parse('2000').before(DateTime.parse('2000')));
  });
...
describe('DateTime.sameOrBefore', function() {
  ...
  it('should return null in cases where a is b but there are unknown values in a and b', function() {
    ...
    return should.not.exist(DateTime.parse('2000').sameOrBefore(DateTime.parse('2000')));
  });
  ...
  it('should accept cases where b has unknown values but a is still deterministicly before or same as b', function() {
...
describe('DateTime.after', function() {
  ...
  it('should return null in cases where a is b but there are unknown values', function() {
    ...
    return should.not.exist(DateTime.parse('2000').after(DateTime.parse('2000')));
  });
...
describe('DateTime.sameOrAfter', function() {
  ...
  it('should return null in cases where a is b but there and b have unknown values', function() {
    ...
    return should.not.exist(DateTime.parse('2000').sameOrAfter(DateTime.parse('2000')));
  });
  ...
  it('should accept cases where b has unknown values but a is still deterministicly same as or after b', function() {
