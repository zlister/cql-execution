...
describe('DateTimeInterval.contains', function() {
  ...
  it('should properly handle imprecision', function() {
    ...
    this.all2012.closed.contains(this.beg2012.toMonth).should.be.true();
    this.all2012.closed.contains(this.mid2012.toMonth).should.be.true();
    this.all2012.closed.contains(this.end2012.toMonth).should.be.true();
    ...
    should.not.exist(this.all2012.toMonth.contains(this.beg2012.toMonth));
    this.all2012.toMonth.contains(this.mid2012.toMonth).should.be.true();
    should.not.exist(this.all2012.toMonth.contains(this.end2012.toMonth));
    ...
    return this.all2012.closed.contains(this.mid2012.toYear).should.be.true();
  });
...
describe('DateTimeInterval.includes', function() {
  ...
  return it('should throw when the argument is a point', function() {
    return should(() => this.all2012.closed.includes(this.mid2012.closed)).throw(Error);
  });
});
...
describe('DateTimeInterval.includedIn', function() {
  ...
  return it('should throw when the argument is a point', function() {
    return should(() => this.all2012.closed.includedIn(this.mid2012.closed)).throw(Error);
  });
});
...
describe('DateTimeInterval.overlaps(DateTime)', function() {
  ...
  return it('should properly handle imprecision', function() {
    ...
    this.all2012.closed.overlaps(this.beg2012.toMonth).should.be.true();
    this.all2012.closed.overlaps(this.mid2012.toMonth).should.be.true();
    this.all2012.closed.overlaps(this.end2012.toMonth).should.be.true();
    ...
    should.not.exist(this.all2012.toMonth.overlaps(this.beg2012.toMonth));
    this.all2012.toMonth.overlaps(this.mid2012.toMonth).should.be.true();
    should.not.exist(this.all2012.toMonth.overlaps(this.end2012.toMonth));
    ...
    return this.all2012.closed.overlaps(this.mid2012.toYear).should.be.true();
  });
});
...
describe('DateTimeInterval.except', function() {
  ...
  it('should properly handle imprecision', function() {
    ...
    return should.not.exist(y.toDay.except(x.toDay));
  });
...
describe('IntegerInterval.includes', function() {
  ...
  return it('should throw when the argument is a point', function() {
    return should(() => this.zeroToHundred.closed.includes(50)).throw(Error);
  });
});
...
describe('IntegerInterval.includedIn', function() {
  ...
  return it('should throw when the argument is a point', function() {
    return should(() => this.zeroToHundred.closed.includedIn(50)).throw(Error);
  });
});
