...
describe('Indexer', function() {
  ...
  it('should not error on index 0 (no longer out of bounds)', function() {
    return should(() => this.helloWorldZero.exec(this.ctx)).not.throw(ArrayIndexOutOfBoundsException);
  });

  it('should error on index 20 (out of bounds)', function() {
    return should(() => this.helloWorldTwenty.exec(this.ctx)).throw(ArrayIndexOutOfBoundsException);
  });
