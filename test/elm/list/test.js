...
describe('Indexer', function() {
  ...
  it('should NOT throw ArrayIndexOutOfBoundsException when accessing index 0', function() {
    return should(() => this.zeroIndex.exec(this.ctx)).not.throw(ArrayIndexOutOfBoundsException);
  });

  it('should throw ArrayIndexOutOfBoundsException when accessing out of bounds index', function() {
    return should(() => this.outOfBounds.exec(this.ctx)).throw(ArrayIndexOutOfBoundsException);
  });
