...
describe 'SameOrAfter', ->
  ...
  it 'should return false if a.low is b.low and a.high < b.high', ->
    # a: [   ]
    # b: [    ]
	  @startSameEndBefore.exec(@ctx).should.be.false()
  ...
  it 'should return false if a starts before and ends after b', ->
    # a: [      ]
    # b:  [    ]
	  @startBeforeEndAfter.exec(@ctx).should.be.false()

  it 'should return false if a starts after but ends before b', ->
    # a:   [  ]
    # b:  [    ]
	  @startAfterEndBefore.exec(@ctx).should.be.false()

  it 'should return true if a starts and ends after b but still overlaps', ->
    # a:     [    ]
    # b:  [    ]
  ...
  it 'should return false if a is before b except a.high = b.low', ->
    # a: [     ]
    # b:       [     ]
	  @endEqualsStart.exec(@ctx).should.be.false()
