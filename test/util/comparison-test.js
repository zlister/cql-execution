...
describe('equivalent', function() {
  ...
  it('should detect if second parameter is not a code and still result to true', () => equivalent(new Code('123', 'test', '2016'), '123').should.be.true());
  ...
  return it('should detect equivalency between code and concept of codes', function() {
